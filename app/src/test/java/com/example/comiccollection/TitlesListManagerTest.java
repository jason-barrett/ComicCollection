...
public class TitlesListManagerTest {
    ...
    @Test
    public void titlesListManager_titleNameExists_yes() {
        TitlesListManager titlesListManager = new TitlesListManager();

        List<Title> titlesIn = new ArrayList<Title>();

        Title titleAction = new Title();
        titleAction.setName("Action Comics");
        titleAction.setFirstIssue("300");
        titleAction.setLastIssue("600");
        ...
        Title titleDoubleAction = new Title();
        titleDoubleAction.setName("Action Comics");
        titleDoubleAction.setFirstIssue("300");
        titleDoubleAction.setLastIssue("600");

        assertTrue(titlesListManager.titleNameExists(titlesIn, titleDoubleAction));

        Title titleDoubleDaredevil = new Title();
        titleDoubleDaredevil.setName("Daredevil");
        titleDoubleDaredevil.setFirstIssue("56");
        titleDoubleDaredevil.setLastIssue("157");

        assertTrue(titlesListManager.titleNameExists(titlesIn, titleDoubleDaredevil));
    }

    @Test
    public void titlesListManager_titleNameExists_no() {
        TitlesListManager titlesListManager = new TitlesListManager();
        ...
        titleSuperman.setFirstIssue("300");
        titleSuperman.setLastIssue("600");

        assertFalse(titlesListManager.titleNameExists(titlesIn, titleSuperman));

        Title titlePowerMan = new Title();
        titlePowerMan.setName("Power Man");
        titlePowerMan.setFirstIssue("1");
        titlePowerMan.setLastIssue("123");

        assertFalse(titlesListManager.titleNameExists(titlesIn, titlePowerMan));
    }
